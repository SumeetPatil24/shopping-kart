...
const Cart = () => {
  ...
  // Safely check if cartItems exists and has length
    ...
    <div className="container mx-auto px-4 py-8 mt-20">
      ...
      {!hasItems ? (
        <div className="bg-white rounded-xl shadow-md p-8 text-center">
          ...
          <Link
            to="/"
            className="bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition duration-300 inline-flex items-center"
          >
            <FaArrowLeft className="mr-2" /> Continue Shopping
          </Link>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                ...
                <button onClick={handleClearCart} className="text-red-600 hover:text-red-800 flex items-center text-sm">
                  <FaTrash className="mr-1" /> Clear Cart
                </button>
              </div>
              ...
              <div className="divide-y divide-gray-200">
                {cartItems.map((cartItem) => (
                  <div key={cartItem.item._id} className="p-6 flex flex-col sm:flex-row items-center">
                    ...
                    <div className="sm:ml-6 flex-grow">
                      <h3 className="text-lg font-semibold text-gray-800 mb-1">{cartItem.item.title}</h3>
                      <p className="text-gray-600 mb-4">${cartItem.item.price.toFixed(2)}</p>
              ...
              <div className="p-6 bg-gray-50 border-t border-gray-200">
                <Link to="/" className="text-indigo-600 hover:text-indigo-800 flex items-center text-sm font-medium">
                  <FaArrowLeft className="mr-2" /> Continue Shopping
                </Link>
              </div>
            </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800 font-medium">${(getCartTotal() * 0.1).toFixed(2)}</span>
                  </div>
                ...
                <button
                  ...
                  className="w-full bg-indigo-600 text-white mt-6 py-3 px-4 rounded-lg hover:bg-indigo-700 transition duration-300 flex items-center justify-center"
                >
                  {isCheckingOut ? (
                    <>
                ...
                <div className="mt-6 flex justify-center">
                  <img src="https://cdn-icons-png.flaticon.com/128/196/196578.png" alt="Visa" className="h-8 mx-1" />
                  <img
                    src="https://cdn-icons-png.flaticon.com/128/196/196561.png"
                    alt="Mastercard"
                    className="h-8 mx-1"
                  />
                  <img src="https://cdn-icons-png.flaticon.com/128/196/196539.png" alt="PayPal" className="h-8 mx-1" />
                  <img
